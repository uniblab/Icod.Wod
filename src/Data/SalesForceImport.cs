...
namespace Icod.Wod.Data {
	...
	public sealed class SalesForceImport : DbIODescriptorBase {

		#region .ctor
		public SalesForceImport() : base() {
		}
		public SalesForceImport( Icod.Wod.WorkOrder workOrder ) : base( workOrder ) {
		}
		#endregion .ctor
		...
		[System.Xml.Serialization.XmlElement(
			"source",
			Type = typeof( SalesForce.Rest.SFSelect ),
			IsNullable = false,
			Namespace = "http://Icod.Wod" )
		]
		public SalesForce.Rest.SFSelect Source {
			get;
			set;
		}
